...
import com.project.server.enums.*;
...
public class EnumGenerator {
    ...
    /**
     * Convert the hump into uppercase underline style and remove _ENUM.
     * For example：SectionChargeEnum ==> SECTION_CHARGE
     * @param str
     * @return
     */
    ...
    /**
     * Convert hump to underline style, and the first character is underline.
     * For example：SectionChargeEnum ==> _section_charge_enum
     * @param str
     * @return
     */
