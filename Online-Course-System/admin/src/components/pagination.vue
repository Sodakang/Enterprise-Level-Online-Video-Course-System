...
<script>
    export default {
        ...
        props: {
            ...
            // The number of pages shown in the pagination component.
            // For instance, there are 100 pages in total. We show 10 pages, the others will be shown as ...
            itemCount: Number
        },
        data: function () {
            return {
                total: 0, // The number of items in total.
                size: 10, // The number of items in each page.
                page: 0, // The current page number.
                pageTotal: 0, // The number of pages in total.
                pages: [], // The array for the pages will be shown.
            }
        },
        methods: {
            /**
            ...
            /**
             * The page numbers will be shown.
             * @param total
             * @param current
             * @param length
             * @returns {Array}
